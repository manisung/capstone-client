...
function AboutPage() {
    return (
        ...
        <div className="about__image-wrapper"><img className="about__image-2" src={wildCity} alt="Yumi's Star Academy competiton" /></div>
...
<div className="about__sub-title">Debut</div>
        <div className="about__image-wrapper"><img className="about__image-3" src={debut} alt="Yumi's new music video mosaic" /></div>
